...
const EmployeeAttendance = () => {
  ...
  // Define table headers for Employee Attendance Details
  const tableHead = ['#', 'Employee ID', 'Name', 'Date', 'Check-In Time', 'Check-Out Time', 'Status'];
  const columnWidths = [50, 100, 150, 100, 120, 120, 100];

  // Sample employee attendance entry
  const sampleEntry = [
    '1',                // #
    'EMP001',           // Employee ID
    'John Doe',         // Name
    ...
    '05:00 PM',         // Check-Out Time
    'Present'           // Status
  ];

  // Combine sample entry into attendanceData
  const attendanceData = [sampleEntry];
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.innerContainer}>
        ...
        <View style={styles.contentContainer}>
          <Text style={styles.headerText}>Employee Attendance Details</Text>
              ...
              <Table borderStyle={{ borderWidth: 1, borderColor: '#ddd' }}>
                ...
                {attendanceData.length > 0 ? (
                  ...
                  <Row
                    ...
                    style={styles.tableRow}
                    textStyle={styles.tableText}
                    widthArr={[700]} // Span the entire width
                  />
                )}
              </Table>
            </View>
